...
while True:
    ...
    if deg_z != None:
        ...
        servo_FL(-1*(height*math.tan(theta_z)), height)
        servo_FR(-1*(height*math.tan(theta_z)), height)
        servo_RL(-1*(height*math.tan(theta_z)), height)
        servo_RR(-1*(height*math.tan(theta_z)), height)
    time.sleep(0.5)